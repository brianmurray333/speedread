              ...
              {documents.map((doc) => (
                ...
                >
                  <div className="flex items-start gap-4">
                    <div className="flex-shrink-0 w-12 h-12 rounded-lg bg-[color:var(--accent)]/10 flex items-center justify-center">
                      <svg 
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="font-semibold text-lg truncate group-hover:text-[color:var(--accent)] transition-colors">
                        {doc.title}
                      </h3>
                  ...
                  <div className="mt-4 flex items-center gap-2 text-[color:var(--accent)] text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity">
